...
var model = {
  ...
  requirements: { 
    ...
    JSON_headings: ["ProjectName","IndentLevel","RequirementId","Name","Description","ReleaseVersionNumber","RequirementTypeId","ImportanceName","StatusId","EstimatePoints",
  ...
  //test case schema for stretch goal
  testCases: {
    headings: [],
    sizes: [],
    dropdowns: []
